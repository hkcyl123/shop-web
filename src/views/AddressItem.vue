  ...
  export default {
    ...
    methods: {
      ...
      async getAddressList() {
        let result = await this.$axios.get('/address/getAddress')
      ...
      async deleteAddress(address_id, index) {
        ...
        let result = await this.$axios.post('/address/deleteAddress', {
          address_id
        })
      ...
      async setDefault(address_id, index) {
        let result = await this.$axios.post('/address/defaultAddress', {
          address_id,
