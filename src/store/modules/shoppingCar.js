export default {
  ...
  actions: {
    ...
    async setCarNumber(context, _) {
      let result = await this._vm.$axios.get('/shoppingCar/carNumber')
    ...
    async getCarList(context, _) {
      let result = await this._vm.$axios.get('/shoppingCar/carList')
